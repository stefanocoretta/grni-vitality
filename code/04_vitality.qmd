...
new_domains_use <- polentometro_page15 |> 
  select(
    CASE, generation, Area, Region,
...
new_domains_use_domains |>
  mutate(
    ...
    question = case_when(
      domain %in% c("Literature", "Messaging", "Doesn't write", "Note taking", "Emails/letters", "Social Media", "TV/radio") ~ "Do you read/write/listen to?",
...
ggsave("img/new-doms.png", width = 10, height = 2.5)
```
